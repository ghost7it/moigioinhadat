...
var Demo = function () {
    ...
    var handleTheme = function () {
        ...
        if ($('.sidebar-pos-option').attr("disabled") === false) {
            $('.sidebar-pos-option', panel).val(AdminVersionOne.isRTL() ? 'right' : 'left');
        }
        ...
        var setLayout = function () {
            ...
            if (lastSelectedLayout != layoutOption) {
                ...
                AdminVersionOne.runResizeHandlers();
            }
        ...
        var setColor = function (color) {
            var color_ = (AdminVersionOne.isRTL() ? color + '-rtl' : color);
