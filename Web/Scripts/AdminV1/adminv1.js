var AdminVersionOne = function () {
    ...
    var assetsPath = '../../../Images/AdminV1/';

    var globalImgPath = assetsPath;

    var globalPluginsPath = assetsPath;
    ...
    // runs callback functions set by AdminVersionOne.addResponsiveHandler().
    ...
    var handlePortletTools = function () {
        ...
        $('body').on('click', '.portlet > .portlet-title .fullscreen', function (e) {
            ...
            if (portlet.hasClass('portlet-fullscreen')) {
                ...
                var height = AdminVersionOne.getViewPort().height -
    ...
    var handleAccordions = function () {
        $('body').on('shown.bs.collapse', '.accordion.scrollable', function (e) {
            AdminVersionOne.scrollTo($(e.target));
        });
    };
    ...
    var handleScrollers = function () {
        AdminVersionOne.initSlimScroll('.scroller');
    };
    ...
    return {
        ...
        alert: function (options) {
            ...
            var id = AdminVersionOne.getUniqueID("Metronic_alert");
