...
namespace Web.Areas.Management.Controllers
{
    ...
    public class PhanCongCongViecController : BaseController
    {
        ...
        public async Task<ActionResult> UpdatePhanCongCongViec(long id, long nhucauId)
        {
        ...
        [Route("danh-sach-phan-cong-cong-viec-json", Name = "GetPhanCongCongViecJson")]
        public ActionResult GetPhanCongCongViecJson()
        {
            string drawReturn = "1";
            ...
            var user = _repository.GetRepository<Account>().GetAll().SingleOrDefault(o => o.Name.Contains(key));
            if (user != null)
            {
                userID = user.Id;
            }
            var khach = _repository.GetRepository<Khach>().GetAll().SingleOrDefault(o => o.TenNguoiLienHeVaiTro.Contains(key));
            if (khach != null)
            {
                khachID = khach.Id;
            }
            var nha = _repository.GetRepository<Nha>().GetAll().SingleOrDefault(o => o.SoNha.Contains(key) || o.TenToaNha.Contains(key));
            if (nha != null)
            {
                nhaID = nha.Id;
            }
            ...
            var articles = _repository.GetRepository<QuanLyCongViec>().GetAll(ref paging,
                                                                  ...
                                                                  o => (key == null ||
                                                                        ...
                                                                        o.KhachId == khachID ||
                                                                        o.NhaId == nhaID))
                                                                        .Join(_repository.GetRepository<Account>().GetAll(), b => b.NhanVienPhuTrachId, e => e.Id, (b, e) => new { QuanLyCongViec = b, Account = e == null ? null : e })
                                                                        .Join(_repository.GetRepository<Khach>().GetAll(), g => g.QuanLyCongViec.KhachId, f => f.Id, (g, f) => new { QuanLyCongViec = g, Khach = f == null ? null : f })
                                                                        .Join(_repository.GetRepository<Nha>().GetAll(), k => k.QuanLyCongViec.QuanLyCongViec.NhaId, y => y.Id, (k, y) => new { QuanLyCongViec = k, Nha = y == null ? null : y }).ToList();
            ...
            return Json(new
            {
                ...
                data = articles.Select(o => new
                {
                    ...
                    NhanVienPhuTrach = o.QuanLyCongViec.QuanLyCongViec.Account.Name,
                    Khach = o.QuanLyCongViec.Khach.TenNguoiLienHeVaiTro,
                    Nha = o.Nha.TenToaNha,
                    TrangThai = o.QuanLyCongViec.QuanLyCongViec.QuanLyCongViec.TrangThai == 0 ? "Chưa gửi" : "Đã gửi"
                })
