...
{
    //NamMV
    //Lớp này dùng để lấy danh sách enum ra 1 selectlist
    //Cách dùng:
    //Khai báo enum:
    //public enum PhamViBaiBao
    //{
    //    [StringValue("Trong nước")]
    //    TrongNuoc = 0,
    //    [StringValue("Quốc tế")]
    //    QuocTe = 1
    //}
    //Gọi: 
    //ViewBag.PhamVi = new SelectList(new StringEnum(typeof(PhamViBaiBao)).GetListValues(), "Key", "Value", string.Empty); 
