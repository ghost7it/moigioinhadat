...
namespace Common
{
    public static class MimeTypeHelper
    {
        ...
        /// <summary>
        /// Danh sách một số định dạng file phổ biến
        /// </summary>
        private static readonly Dictionary<string, string> MIMETypesDictionary = new Dictionary<string, string>
  {
    ...
    {"zip", "application/zip"}
        ...
        /// <summary>
        /// Danh sách các định dạng file ảnh
        /// </summary>
        private static readonly Dictionary<string, string> ImagesMIMETypesDictionary = new Dictionary<string, string>
  {
    {"bmp", "image/bmp"},
    {"cgm", "image/cgm"},
    {"djv", "image/vnd.djvu"},
    ...
    {"xwd", "image/x-xwindowdump"}
        ...
        private static readonly Dictionary<string, string> AcceptedImagesMIMETypesDictionary = new Dictionary<string, string>
  {
    {"bmp", "image/bmp"},
    {"gif", "image/gif"},
    {"jpe", "image/jpeg"},
